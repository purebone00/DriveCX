...
public class AverageCheckNegativeNumbers {
  ...
  @Test
  public void AverageCheckNegativeNumbers_test() throws Exception {
	
	  driver.get(baseUrl);
	  driver.findElement(By.id("cf-averageCheck")).click();
	  driver.findElement(By.id("cf-averageCheck")).clear();
	  driver.findElement(By.id("cf-averageCheck")).sendKeys("-99999999999999");
