...
public class AverageCheckNumbersInt {
  ...
  @Test
  public void AverageCheckNumbersInt_test() throws Exception {
	  ...
	  assertEquals("Average check: 1", driver.findElement(By.xpath("//p[3]")).getText());
