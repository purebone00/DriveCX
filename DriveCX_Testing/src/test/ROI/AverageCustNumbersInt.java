...
public class AverageCustNumbersInt {
  ...
  public void verify_FirstName_test() throws Exception {
	  ...
	  driver.findElement(By.id("cf-averageCustNo")).sendKeys("1.2");
	  ...
	  assertEquals("Average customer number: 1.2", driver.findElement(By.xpath("//p[3]")).getText());
