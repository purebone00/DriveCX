...
public class CompanyName_Empty {
  ...
  public void verify_FirstName_test() throws Exception {
	  ...
	  driver.findElement(By.id("cf-companyName")).click();
	  driver.findElement(By.id("cf-companyName")).clear();
	  driver.findElement(By.id("cf-companyName")).sendKeys("");
	  driver.findElement(By.cssSelector("div.card.card-container")).click();
	  assertEquals("Please enter a company name", driver.findElement(By.cssSelector("li")).getText());
